...
data class DetailCartMerchResponse(

	@field:SerializedName("itemMerchCart")
	val itemMerchCart: ItemMerchCart? = null,

	@field:SerializedName("error")
	val error: Boolean? = null
)

data class ItemMerchCart(
